 ...
 */
#define E0_AUTO_FAN_PIN -1 //dependent on pin def'n in pins_BIGTREE_SKR_V1.3h
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 30*60, 2*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
